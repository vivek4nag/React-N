...
const Header = () => {
  ...
  //subscribing to store using selector to update cart - selector is a hook at the end of the day
  // we are subscribing to the store & in that to subscribing to very small portion store.cart.items
